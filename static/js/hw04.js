...
const post2Html = post => {
    ...
    <div class="commentsNStuff">
        ...
        <div class="caption">
            <p><b>${post.user.username}</b> ${post.caption}</p> <a data-post-id=${post.id} onclick="openModal();">more</a>
        </div>
        <div class="comments">
            ${comments}
        </div>
...
function openModal(postId) {
    ...
    `
    <div class="modal-img">
        <img src="https://i.natgeofe.com/n/46b07b5e-1264-42e1-ae4b-8a021226e2d0/domestic-cat_thumb_square.jpg">
    </div>
